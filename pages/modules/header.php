      ...
      <div class="deroule-menu" id="biblio">
        ...
        <div id="login">
          <div  class="deroule-menu">
            <a href="../systeme-de-connexion/connexion.php">
              <?php if(isset($_SESSION['logged_user'])): ?>
                  <img src="../systeme-de-connexion/avatar.php" alt="Avatar" height="50" width="50">
              <?php else: ?>
          ...
          <?php if (isset($_SESSION['logged_user'])) { ?>
            <div class="sous-menu" id="login-sous-menu">
                <a href="../systeme-de-connexion/profil.php">Profil</a>
                <a href="../systeme-de-connexion/deconnexion.php">Se deconnecter</a>
            </div>
            <?php } else { ?>
              <div class="sous-menu" id="login-sous-menu">
                  <a href="../systeme-de-connexion/connexion.php">Se connecter</a>
                  <a href="../systeme-de-connexion/creation.php">Créer un compte</a>
              </div>
            <?php } ?>
      </div>
  </header>
